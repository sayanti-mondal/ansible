...
9. Exercise9 - In this project demonstated variable precedence concept based on the location of variable and list, dictionary, environment variables  
       ...
       - Runtime variable/environment variable command -> ansible-playbook example.yml -e "variable_name=value"       - Then we created another playbook to understand the concept of list and dictionary variables  
